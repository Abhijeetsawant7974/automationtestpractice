...
public class Signupregistration {
WebDriver driver;
	...
	public Signupregistration(WebDriver driver) {
	...
	public void setSignuppagebirthday() throws EncryptedDocumentException, IOException{
		...
		FileInputStream f1=new FileInputStream("C:\\Users\\Abhijeet\\Desktop\\user.xlsx");
		String birthday = WorkbookFactory.create(f1).getSheet("registerdata").getRow(1).getCell(1).getStringCellValue();
